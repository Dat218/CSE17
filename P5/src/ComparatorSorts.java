...
public class ComparatorSorts <T extends Comparable<T>> {
	...
	/*
	 * This method will correctly place the pivot in the correct index of the array so that all values to the
	 * left of the pivot is less than the pivot value and all values to the right of the 
	 * pivot are higher than the pivot value.
	 */
