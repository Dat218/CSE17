...
public class Song {
	...
	private int time;
	private int year;
	public static final Comparator<Song> SongTitleComparator = new TitleComparator(); //A constant instance with a compare() method that orders by title (ascending).
	public static final Comparator<Song> SongArtistComparator = new ArtistComparator(); //A constant instance with a compare() method that orders by artist (ascending).
	public static final Comparator<Song> SongYearComparator = new YearComparator(); //A constant instance with a compare() method that orders by year (ascending).
	...
	static class YearComparator implements Comparator<Song> {
		public int compare(Song o1, Song o2) {
